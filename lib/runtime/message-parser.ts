...
const ARTIFACT_ACTION_TAG_CLOSE = '</boltnextAction>';

const logger = createScopedLogger('MessageParser');

export interface ArtifactCallbackData extends BoltNextArtifactData {
  messageId: string;
}
...
interface MessageState {
  ...
  currentArtifact?: BoltNextArtifactData;
  currentAction: BoltNextActionData;
  actionId: number;
}
...
export class StreamingMessageParser {
        ...
        if (state.insideAction) {
          ...
          if (closeIndex !== -1) {
            ...
            this._options.callbacks?.onActionClose?.({
              ...
              action: currentAction as BoltNextAction,
            });
          ...
          if (actionOpenIndex !== -1 && (artifactCloseIndex === -1 || actionOpenIndex < artifactCloseIndex)) {
            ...
            if (actionEndIndex !== -1) {
              ...
              this._options.callbacks?.onActionOpen?.({
                ...
                action: state.currentAction as BoltNextAction,
              });
          ...
          if (potentialTag === ARTIFACT_TAG_OPEN) {
            ...
            if (openTagEnd !== -1) {
              ...
              const currentArtifact = {
                id: artifactId,
                title: artifactTitle,
              } satisfies BoltNextArtifactData;
  ...
  #parseActionTag(input: string, actionOpenIndex: number, actionEndIndex: number) {
    ...
    const actionAttributes: Partial<BoltNextAction> = {
      type: actionType,
      content: '',
    };
    ...
    return actionAttributes as BoltNextAction;
  }
